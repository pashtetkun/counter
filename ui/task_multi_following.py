...
class FrameLikes(ttk.Frame):
    ...
    Spinbox.field -sticky {} -children {
        ...
        self.check_likes = ttk.Checkbutton(self, text="Лайки", state="disabled")
        ...
        self.spinbox_likes = spinbox.Spinbox(self, from_=0, to=10, increment=1, state="disabled")
        ...
        self.random_likes = ttk.Checkbutton(self, text="Добавлять лайки под случайными записями",
                                            variable=self.var_random_likes, state="disabled")
...
class FramePause(ttk.Frame):
    def __init__(self, parent):
        ...
        #self.var_check_likes = tk.IntVar()
        self.check_pause = ttk.Checkbutton(self, text="Случайная пауза", state="disabled")
        ...
        self.spinbox_followers = spinbox.Spinbox(self, from_=1, to=10, increment=1, state="disabled")
        ...
        self.spinbox_pause_from = spinbox.Spinbox(self, from_=1, to=10, increment=1, state="disabled")
        self.spinbox_pause_from.grid(row=2, column=2)
        self.label5 = ttk.Label(self, text="до")
        self.label5.grid(row=2, column=3, sticky="w")
        self.spinbox_pause_to = spinbox.Spinbox(self, from_=1, to=10, increment=1, state="disabled")
...
class TaskMultiFollowingWindow(tk.Toplevel):
    def __init__(self, width, height, parent, callback=None):
        ...
        self.entry_logins = ttk.Entry(self.frame, textvariable=self.var_logins, state="disabled")
        self.entry_logins.grid(row=1, column=2, columnspan=3, sticky="ew")
        self.button_choose = ttk.Button(self.frame, text="Выбрать", state="disabled")
        ...
        self.check_private = ttk.Checkbutton(self.frame, text="не подписываться на приватные страницы",
                                             variable=self.var_check_private, state="disabled")
        ...
        self.check_followed = ttk.Checkbutton(self.frame, text="не подписываться на тех, кто находится в подписчиках",
                                              variable=self.var_check_followed, state="disabled")
        ...
        self.button_add = ttk.Button(self.frame, text="Добавить задание", state="disabled")
